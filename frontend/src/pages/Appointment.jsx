...
import RelatedDoctoes from '../components/RelatedDoctors'
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          {/* doctor information name deeger
           exper
            */}
          ...
          {/* doctor about */}
          <div>
            <p className='flex text-center text-sm gap-1 font-medium text-gray-900 mt-3'>About <img src={assets.info_icon} alt="" /></p>
      ...
      {/* Related Doctors */}
      <RelatedDoctoes docId={docId} speciality={docInfo.speciality} />
